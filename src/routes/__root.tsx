  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "El Portal Magnético — Orgones y artesanías hechos a mano" },
      {
        ...
        content:
          "Objetos escultóricos de cristal, cobre y resina botánica. Piezas artesanales hechas a mano.",
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Instrument+Serif:ital@0;1&family=Inter+Tight:wght@300;400;500&family=JetBrains+Mono:wght@400&display=swap",
      },
    ],
  }),
